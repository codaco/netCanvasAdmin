  ...
  switch (e.friendlyCode) {
      ...
      return (
        <>
          <p>
            Could not save/open &quot;
            {fileName}
            &quot; due to a permissions issue. Please check that the file is not
            &quot;read only&quot;.
          </p>
          <p>
          ...
          <p>
            Please contact the Network Canvas team if you need support with this
            issue.
          </p>
        </>
      );
    case netcanvasFileErrors.ReadError:
      return (
        <p>
          ...
          {fileName}
          &quot;. See the information below for details about why this error
          occurred. Please contact the Network Canvas team if you need support
          with this issue.
        </p>
      );
    case netcanvasFileErrors.WriteError:
      return (
        <>
          <p>
            Saving failed because there was an error writing the file. Check
            that you have enough disk space, or try saving to a different
            location. The original file has not been changed. See the
            information below for details about why this error occurred.
          </p>
          <p>
            If you continue to encounter this error, please contact the Network
            Canvas team for support.
          </p>
        </>
      );
    case netcanvasFileErrors.CreateFailed:
      return (
        <p>
          Architect failed to create a new protocol file. This may mean it could
          not write to the temporary directory, or it could not read the
          template file. Please contact the Network Canvas team for support with
          this issue. See the information below for details about why this error
          occurred.
        </p>
      );
    case netcanvasFileErrors.SaveFailed:
      return (
        <>
          <p>
            Saving failed. Check that you have enough disk space, or try saving
            to a different location. The original file has not been changed. See
    ...
    case netcanvasFileErrors.OpenFailed:
      return (
        <>
          <p>
            Opening this protocol file failed. See the information below for
            details about why this error occurred.
          </p>
          <p>
            If you continue to encounter this error, please contact the Network
            Canvas team for support, including a copy of your protocol file.
          </p>
        </>
      );
    case netcanvasFileErrors.VerificationFailed:
      return (
        <p>
          Saving failed because the result could not be verified. Your original
          netcanvas file has not been changed. See the information below for
          details about why this error occurred.
        </p>
      );
    default:
...
const importErrorDialog = (e) => {
  e.friendlyMessage = (
    <p>
      There was an error downloading or importing the sample protocol. Please
      consult the error message below for details. If you believe you have
      encountered a bug in the software, please help us to troubleshoot this
      issue by creating a topic on our&nbsp;
...
const validationErrorDialog = (e) => {
  e.friendlyMessage = (
    <>
      <p>
        The protocol format seems to be invalid. Please help us to troubleshoot
        this issue by by creating a topic on our&nbsp;
        <ExternalLink href="https://community.networkcanvas.com/">
          community website
        </ExternalLink>
        &nbsp; with further details.
  ...
  const message = (
    <>
      ...
      <p>
        ...
        that supports schema version {protocolSchemaVersion}.
      </p>
      <p>
        Please see our{" "}
...
const mayUpgradeProtocolDialog = (
  ...
  const message = (
    <>
      ...
      <p>
        It can be automatically upgraded to schema version {targetSchemaVersion}{" "}
        using our migration feature, OR you can downgrade your version of
        Architect to continue editing this protocol without changing its schema
        version.
      </p>
          ...
          <div className="migration-panel">
            {migrationNotes.map(({ version, notes }) => (
              <React.Fragment key={version}>
                ...
                <Markdown
                  label={notes}
                  markdownRenderers={{ a: ExternalLink }}
                />
              </React.Fragment>
            ))}
          </div>
