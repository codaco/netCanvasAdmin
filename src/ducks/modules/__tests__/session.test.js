  ...
  describe("actions", () => {
    ...
    it("open netcanvas dispatches the correct actions and side-effects", async () => {
      ...
      await store.dispatch(
        actionCreators.openNetcanvas("/dev/null/mock.netcanvas")
      );
      ...
      expect(readProtocol.mock.calls).toEqual([["/dev/null/working/path"]]);
    ...
    describe("save actions", () => {
      ...
      beforeEach(() => {
        saveNetcanvas.mockImplementation((workingPath, protocol, savePath) =>
      ...
      it("saveAsNetcanvas()", async () => {
        await store.dispatch(
          actionCreators.saveAsNetcanvas(
