...
const attributes = [
  ...
  [
    "edges.create",
    "Creates edge",
    (type) => <EntityBadge entity="edge" type={type} tiny link />,
  ],
  [
    "createEdge",
    "Creates edge",
...
const Prompt = ({ text, additionalAttributes, ...prompt }) => {
