...
const isOrdinalOrCategoricalType = (variableType) =>
...
const isBooleanWithOptions = (component) =>
  component === COMPONENTS.BooleanChoice.value;
...
const getColorForType = (type) =>
  get(VARIABLE_TYPES, [type, "color"], "var(--color-charcoal)");
